        ...
        <div class="container header-container flex">
                ...
                <nav class="header-nav">
                    <ul class="header-nav-links">
                        <li class="header-nav-link"><a href="#services"  class="js-scroll">Услуги</a></li>
                        <li class="header-nav-link"><a href="#goods"  class="js-scroll">Товары</a></li>
                        <li class="header-nav-link"><a href="#production"  class="js-scroll">Производство</a></li>
                        <li class="header-nav-link"><a href="#contacts"  class="js-scroll">Контакты</a></li>
                        <button class="header-close-btn" type="button">
                            <span class="header-close-btn-line"></span>
                        </button>
                    </ul>
                </nav>
